...
public class AnimalDog extends Animal
{
	...
	*/
	...
	// 생성자 메서드
	public AnimalDog(String species, int age, String genter, String dogKind, String name)
	{
		/*
			자식클래스에서는 바느드시 부모클래스의 객체를 먼저 셍성해야 한다.
			여기서 사용된 super()는 부모클래스의 생성자 메서드를 호출하는 
			용도로 사용된다.
		*/
		super(species, age, genter);
		// 자신의 멤버변수를 초기화한다.
